      ...
      <AnimatePresence>
        {isOpen ? (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            />
            <motion.div
              className={`relative rounded-2xl border border-outline bg-surface-container shadow-surface-lg ${widthClassName}`}
            ...
            >
              <div className="flex max-h-[85vh] flex-col">
                ...
                {footer ? <div className="border-t border-outline px-6 py-4">{footer}</div> : null}
              </div>
            </motion.div>
          </div>
        ) : null}
